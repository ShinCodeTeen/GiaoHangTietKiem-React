...
function Content (){
    ...
    const handleRegister=()=>{
        if(ten==''||numberPhone==''||location==''||passWord==''||commitPass==''){
            Swal.fire({
                title: "Error",
            ...
            Swal.fire({
                ...
                try {
                    const userId ="Ship"+generateRandomString(5) 
                    ...
                    if (response.data.success) {
                        Toast.fire({
                            icon: "success",
                            title: "Đăng kí thành công thành công!"  
                        });
                        ResetInput()
                    } else {
    ...
    return(
        <div id='content_lg'>
            ...
            <div className='register'>
                <h1>Đăng kí làm người giao hàng</h1>
                <input
                ...
                />
                 <input
                    placeholder='Địa chỉ email (example@gmail.com)'
                    value={email}
